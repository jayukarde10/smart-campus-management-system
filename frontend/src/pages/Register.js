...
function Register() {
  ...
  return (
    <div className="d-flex align-items-center justify-content-center min-vh-100 position-relative border-0" style={{ background: 'linear-gradient(135deg, #f3e8ff, #e0e7ff, #dbeafe)' }}>
      
      {/* Decorative Blobs */}
      <div className="position-absolute rounded-circle" style={{ width: '400px', height: '400px', background: 'radial-gradient(#a78bfa, #c084fc)', filter: 'blur(80px)', top: '-10%', right: '-10%', opacity: 0.4 }}></div>
      <div className="position-absolute rounded-circle" style={{ width: '300px', height: '300px', background: 'radial-gradient(#38bdf8, #818cf8)', filter: 'blur(80px)', bottom: '-5%', left: '-5%', opacity: 0.4 }}></div>
      ...
      <div className="col-11 col-md-8 col-lg-5 z-1 animate-fade-in py-5">
        <div className="glass-panel p-5">
          ...
          <form onSubmit={handleRegister}>
            ...
            <button type="submit" className="btn-dynamic w-100 py-3 mb-4" disabled={loading}>
