  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-4">
        ...
        <p className="text-muted m-0">View your marks shared by faculty.</p>
      </div>
      ...
      {marks.length === 0 ? (
        <div className="premium-card p-5 text-center text-muted">
          ...
          <h5 className="fw-bold">No marks available yet</h5>
          <p>Your faculty hasn't shared any marks. Check back later.</p>
        </div>
      ) : (
                  ...
                  {subMarks.map(m => {
                    ...
                    return (
                      <tr key={m._id}>
                        ...
                        <td className="px-3">
                          {m.fileUrl ? (
                            <a href={`http://localhost:5000${m.fileUrl}`} target="_blank" rel="noreferrer" className="btn btn-sm btn-outline-primary d-flex align-items-center gap-1 fw-bold" style={{fontSize:'12px'}}>
